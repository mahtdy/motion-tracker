...
// ================== VERSION CHECK ==================
console.log('%c🚀 Motion Tracker v1.4.5', 'color: #22c55e; font-size: 16px; font-weight: bold');
console.log('%cUI: Professional layered layout with proper z-index', 'color: #3b82f6; font-size: 12px');
